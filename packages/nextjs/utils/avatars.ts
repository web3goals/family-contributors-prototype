...
/**
 * Get color and emoji by address.
 *
 * Source - https://github.dev/rainbow-me/rainbowkit/blob/main/packages/rainbowkit/src/components/Avatar/emojiAvatarForAddress.ts
 */
